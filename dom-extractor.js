(() => {
  ...
  function extractPageContext() {
    try {
      ...
      textContent = textContent.replace(/\[\s*\]\([^)]+\)/g, "").replace(/^#+\s*$/gm, "").replace(/\n{3,}/g, "\n\n").trim();
      const truncateNote = isEn ? "\n\n...[Content truncated due to length]" : "\n\n...[\u0130\xE7eri\u011Fin devam\u0131 s\u0131\u011Fmad\u0131\u011F\u0131 i\xE7in kesildi]";
      if (textContent.length > 5e3) {
        textContent = textContent.slice(0, 5e3) + truncateNote;
      }
      ...
      const contentText = isEn ? "Page Content" : "Sayfa \u0130\xE7eri\u011Fi";
      const closingText = isEn ? "Please analyze this webpage in detail and summarize it for me." : "L\xFCtfen bu web sayfas\u0131n\u0131 detayl\u0131 analiz et ve bana \xF6zetle.";
      let formattedPrompt = `${headerText}
\u{1F4CC} ${titleText}: ${title}
\u{1F517} ${linkText}: ${url}
...
Sayfa metni ay\u0131klan\u0131rken hata olu\u015Ftu: ${err.message}`;
  ...
  function cleanWebAppText(rootEl) {
    ...
    const noiseSelectors = [
      ...
      "[aria-label='Kimi takip etmeli']",
      "[aria-label='G\xFCndemdekiler']",
    ...
    const blockTags = /* @__PURE__ */ new Set(["DIV", "P", "TR", "LI", "H1", "H2", "H3", "H4", "H5", "H6", "SECTION", "ARTICLE", "HEADER", "FOOTER", "TABLE", "MAIN", "FORM"]);
    ...
    const noisePhrases = [
      // Gmail UI noise
      "sekmeniz bo\u015F",
      "sekme eklemek veya \xE7\u0131karmak",
      "ileti dizisinin \xF6nemli oldu\u011Funu \xF6\u011Fretmek",
      "kotan\u0131n %",
      "son hesap etkinli\u011Fi",
      "\u015Fartlar \xB7 gizlilik",
      "program politikalar\u0131",
      "herhangi bir ileti dizisi se\xE7ilmedi",
      "t\xFCm\xFChi\xE7biriokunanlar",
      "dikey b\xF6lme",
      "yatay b\xF6lme",
      "b\xF6lme yok",
      "1 sat\u0131rdan 1\u20131",
      "posta al\u0131n\u0131yor",
      "di\u011Fer tan\u0131t\u0131mlar e-postalar\u0131",
      "pazarlama, ilgi alanlar\u0131",
      "onaylar, makbuzlar",
      "sosyal a\u011Flardan",
      // YouTube UI noise
      "abone ol",
      ...
      "yak\u0131nda",
      "\u015Fimdi oynat",
      "\xFCcretli tan\u0131t\u0131m i\xE7erir",
      "bilgi",
      "al\u0131\u015Fveri\u015F",
      "videolar",
      "hakk\u0131nda",
      "soru sorun",
      "yan\u0131t al\u0131n, konular\u0131 ke\u015Ffedin ve daha fazlas\u0131n\u0131 yap\u0131n.",
      "k\u0131rpmaya reklam bittikten sonra devam edin",
      "reklam oynat\u0131l\u0131rken klip olu\u015Fturamazs\u0131n\u0131z",
      "herkese a\xE7\u0131k",
      "yorumlar",
      "t\xFCm\xFC",
      "ilgili",
      ...
      "t\xFCrkiye tarihinde g\xFCndemde",
      "spor \xB7 g\xFCndemdekiler"
    ];
